...
class Booking(models.Model):
    ...
    id_enlace = models.IntegerField(null=True)
    url_qr_code_enlace = models.CharField(max_length=255, null=True)
    url_enlace = models.CharField(max_length=255, null=True)
    esta_productivo = models.BooleanField(null=True)
    id_transaction_wompi = models.CharField(max_length=150)
